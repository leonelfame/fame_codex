...
test("Interrupt hook command is absolute, quoted, and bound to the exact application home", () => {
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["/Applications/Fame Codex.app/runtime/bun", "/Applications/Fame Codex.app/app/cli.js"] },
    "/Users/test/Application Support/Fame Codex",
    "darwin",
  )).toBe(
    "'/Applications/Fame Codex.app/runtime/bun' '/Applications/Fame Codex.app/app/cli.js'"
      + " '--home' '/Users/test/Application Support/Fame Codex' 'hook' 'interrupt'",
  );
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["C:\\Program Files\\Fame Codex\\bun.exe", "C:\\Program Files\\Fame Codex\\cli.js"] },
    "C:\\Users\\test\\Fame Codex",
    "win32",
  )).toBe(
    '"C:\\Program Files\\Fame Codex\\bun.exe" "C:\\Program Files\\Fame Codex\\cli.js"'
      + ' "--home" "C:\\Users\\test\\Fame Codex" "hook" "interrupt"',
  );
});
