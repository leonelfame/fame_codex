...
function schedulePersist(): void {
  ...
  // Resolve the target path now: tests may swap FAME_CODEX_HOME before the
...
export function flushResponseState(): void {
  if (!persistTimer) return;
  // Use the path captured when the write was scheduled; FAME_CODEX_HOME may have moved.
