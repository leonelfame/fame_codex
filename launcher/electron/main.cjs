...
const GITHUB_URL = "https://github.com/leonelfame/fame_codex";
...
const launchEnvironment = {
  FAME_CODEX_HOME: process.env.FAME_CODEX_HOME,
  CODEX_HOME: process.env.CODEX_HOME,
};
process.env.FAME_CODEX_HOME = CORE_HOME;
...
const NATIVE_COPY = Object.freeze({
  "en": Object.freeze({
    ...
    retry: "Retry",
    startupTitle: "Fame Codex could not start",
  ...
  "ja": Object.freeze({
    ...
    retry: "再試行",
    startupTitle: "Fame Codex を起動できませんでした",
