...
<p align="center">
  <a href="https://github.com/leonelfame/fame_codex/releases/download/v5.0.21/fame-codex-5.0.21-mac-x64.dmg">macOS Intel</a> · <a href="https://github.com/leonelfame/fame_codex/releases/latest">모든 릴리스</a>
</p>
...
<p align="center">
  <a href="#get-started">시작하기</a> · <a href="https://github.com/leonelfame/fame_codex/releases">업데이트</a> · <a href="docs/architecture.md">아키텍처</a> · <a href="TROUBLESHOOTING.md">문제 해결</a>
</p>
...
Zero Risk는 ChatGPT 페이지를 읽거나 조작하지 않습니다. 모델과 `Fame Codex Zero Risk` 커넥터를 직접 선택하고, 준비된 프롬프트를 붙여넣어 전송한 다음 런처에서 **Sent**를 확인하세요. 자동 모드의 각 모델 항목은 고정된 ChatGPT 모드에 대응하며, Codex의 Effort와 Speed 설정으로 바뀌지 않습니다.
...
> [Limits](https://github.com/leonelfame/fame_codex/discussions/309)를 참고하세요.
...
2. ChatGPT **Developer Mode**를 활성화하고, **Tunnel** 방식의 새 커넥터를 만들고 이름을 정확히
   **Fame Codex Native2**로 지정합니다. **Authentication: None**과 **Allow all actions**를 사용합니다.
3. **런타임 검증**을 실행해 **Fame Codex Native2**가 연결되어 사용 가능한지 확인합니다.
...
`dev:launcher`는 `~/.fame-codex-dev`의 별도 프로필과 계정을 사용합니다. `dev:chat`은 실제 브라우저와 compaction 경로를 사용하며, 도구 결과는 명시적인 시뮬레이션입니다. 일반 Codex 경로는 변경하지 않습니다. 설정과 명령은 [DEV chat harness](docs/dev-chat.md)를 참고하세요.
...
<a href="https://www.star-history.com/?repos=leonelfame%2Ffame_codex&type=date&legend=top-left">
  <picture>
    ...
    <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=leonelfame/fame_codex&type=date&legend=top-left&sealed_token=hBVvg_eOjfMFDrfyeo5FPQkIwcvBEmXc6F7ZoOKnfFE4KPCs67o34w4XwVuM-bHGnKR-SKCAN_TSTWrzuqSBNU-RjNZCLT4f-xNs9qcDhciQtemxHKuuFj0N5YNqZIihdaQfakrh2ANhOrvP0K2LmLXX2zbsYyVaYZknyTnlYeIS_mOGvMcO32ZmPCHK">
  </picture>
</a>

---

[문제 해결](TROUBLESHOOTING.md) · [보안](SECURITY.md) · [프로젝트 고지](FAME_CODEX_NOTICE.md) · [CI](https://github.com/leonelfame/fame_codex/actions/workflows/ci.yml)
