...
REPOSITORY="${CODEX_CHATGPT_WEB_REPOSITORY:-leonelfame/fame_codex}"
...
for DOC in FAME_CODEX_NOTICE.md codex-chatgpt-web-MIT.txt Bun-1.4.0.md THIRD_PARTY_NOTICES.txt; do
...
ln -sfn "$TARGET_DIR/bin/codex-chatgpt-web" "$BIN_DIR/.fame-codex.next"
mv -f "$BIN_DIR/.fame-codex.next" "$BIN_DIR/codex-chatgpt-web"
